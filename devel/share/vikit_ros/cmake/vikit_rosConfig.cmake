...
if("TRUE" STREQUAL "TRUE")
  set(vikit_ros_SOURCE_PREFIX /home/andi/lite_fast_livo2/src/rpg_vikit/vikit_ros)
  set(vikit_ros_DEVEL_PREFIX /home/andi/lite_fast_livo2/devel)
  ...
  set(vikit_ros_INSTALL_PREFIX /home/andi/lite_fast_livo2/install)
...
if(NOT "/home/andi/lite_fast_livo2/src/rpg_vikit/vikit_ros/include;/usr/include/eigen3;/usr/include/opencv4 " STREQUAL " ")
  set(vikit_ros_INCLUDE_DIRS "")
  set(_include_dirs "/home/andi/lite_fast_livo2/src/rpg_vikit/vikit_ros/include;/usr/include/eigen3;/usr/include/opencv4")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'vikit_ros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/andi/lite_fast_livo2/src/rpg_vikit/vikit_ros/${idir}'.  ${_report}")
    endif()
